...
#
#       python ./download-all-2018-08-01_18-34-31.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2018-08-01_18-34-31.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    ...
    def check_cookie(self):
       ...
       try:
          ...
          print ("  New users: you must first log into Vertex and accept the EULA. In addition, your Study Area must be set at Earthdata https://urs.earthdata.nasa.gov")
          exit(-1)
    ...
    def get_new_cookie(self):
       ...
       try:
          ...
          if e.code == 401:
             ...
             print (" IMPORTANT: There was an error obtaining a download cookie!")
             print ("Your user appears to lack permission to download data from the ASF Datapool.")
             print ("  New users: you must first log into Vertex and accept the EULA. In addition, your Study Area must be set at Earthdata https://urs.earthdata.nasa.gov")
             exit(-1)
       except URLError as e:
          print (" IMPORTANT: There was a problem communicating with URS, unable to obtain cookie. ")
    ...
    def download_file_with_cookiejar(self, url, file_count, total, recursion=False):
          ...
          try:
             ...
             if remote_size:
                 ...
                 if remote_size < (local_size+(local_size*.01)) and remote_size > (local_size-(local_size*.01)):
                     print (" > Download file {0} exists!   > Skipping download of {1}. ".format(download_file, url))
                     return None,None
       ...
       try:
          ...
          if response.geturl() != url:
             ...
             print (" > 'Temporary' Redirect download @ Remote archive:  > {0}".format(response.geturl()))
